...
# Assuming SumoEnvironment is a placeholder for your simulation environment management
# This requires that your SumoEnvironment class or equivalent functionality is properly implemented.
...
if __name__ == "__main__":
    ...
    # Number of runs and episodes (simulations)
    runs = 30
    episodes = 4
    env = SumoEnvironment(
    ...
    for run in range(1, runs + 1):
        for episode in range(1, episodes + 1):
            ...
            traci.close()  # Close the simulation for the current run
            plot_waiting_times(waiting_times, run)  # Plot waiting times for the current run
