...
if __name__ == "__main__":
    ...
    for episode in range(1, episodes + 1):
        ...
        total_vehicles_end_episode = []  # Track total vehicles at the end of each episode
        ...
        total_vehicles_end_episode.append(len(vehicles))  # Store the total number of vehicles at the end of the episode
    ...
    # Print total vehicles at the end of each episode
    for i, total_vehicles in enumerate(total_vehicles_end_episode):
        print(f"Total vehicles at the end of episode {i+1}: {total_vehicles}")
